...
public class UtilsConstants {
    public static final String ENTER_DATE_PROMPT = "Enter event date (YYYY-MM-DD): ";
    public static final String ENTER_START_TIME_PROMPT = "Enter event start time (HH:MM): ";
    public static final String ENTER_END_TIME_PROMPT = "Enter event end time (HH:MM): ";
    ...
    public static final String ENTER_EMAIL_PROMPT = "Enter email: ";
